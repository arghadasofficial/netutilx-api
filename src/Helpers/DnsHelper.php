...
class DnsHelper
{
    ...
    {
        return $this->executeQuery("dig @$server MX $domain +noall +answer");
    }

    function soaQuery($domain, $server)
    {
        return $this->executeQuery("dig @$server SOA $domain +noall +answer");
    }

    function txtQuery($domain, $server)
    {
        return $this->executeQuery("dig @$server TXT $domain +noall +answer");
    }

    function ptrQuery($ip)
    {
        return $this->executeQuery("dig -x $ip +noall +answer");
    }
